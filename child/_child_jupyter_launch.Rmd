...
AnVIL_module_settings$text <- "1. Click on the name of your Workspace. You should be routed to a link that looks like: `https://anvil.terra.bio/#workspaces/<billing-project>/<workspace-name>`."

# student version - remind students which workspace they should be using
if (AnVIL_module_settings$audience == "student") {
  AnVIL_module_settings$text <- paste0("1. Click on the name of your Workspace (e.g. `", AnVIL_module_settings$clone_name, "`). You should be routed to a link that looks like: `https://anvil.terra.bio/#workspaces/<billing-project>/<workspace-name>`.")
}
```
