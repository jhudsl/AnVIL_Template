...
# student version
if (AnVIL_module_settings$audience == "student") {
  AnVIL_module_settings$text <- paste0("For this activity, you should launch Jupyter from your copy of the Workspace **", 
                                        AnVIL_module_settings$workspace_name, 
                                        "**. (It should be named something like `", 
                                        AnVIL_module_settings$clone_name, 
                                        "`). If you don't yet have your own copy, make one now by cloning the Workspace **", 
                                        AnVIL_module_settings$workspace_name, 
