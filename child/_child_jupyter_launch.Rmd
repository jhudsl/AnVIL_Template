...
# student version
if (AnVIL_module_settings$audience == "student") {
  AnVIL_module_settings$text <- "For this activity, you should launch Jupyter from your copy of the Workspace `r AnVIL_module_settings$workspace_name`. If you don't yet have your own copy, make one now by cloning the Workspace `r AnVIL_module_settings$workspace_name`."
}
```
