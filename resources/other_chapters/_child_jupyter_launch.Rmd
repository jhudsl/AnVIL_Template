...
# student version
if (AnVIL_module_settings$audience == "student") {
  AnVIL_module_settings$text <- "For this activity, you should launch Jupyter from your copy of the `workspace-name` workspace. If you don't yet have your own copy, make one now by cloning the `workspace-name` Workspace."
}
```
